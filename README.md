Placeholder_Elasticsearch v0.1.1gitt
...
1.  Осуществляет соединение с NATS.
2.  Получает кейсы от TheHive в формате JSON.
3.  Выполняеся передача кейсов TheHive в СУБД Elasticsearch.
